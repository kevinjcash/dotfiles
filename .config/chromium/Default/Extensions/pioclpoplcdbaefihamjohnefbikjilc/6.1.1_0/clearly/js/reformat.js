...
{_fonts_urls.push(''+'http'+(/^https:/gi.test($R.window.location.href)?'s':'')+'://fonts.googleapis.com/css?family='+
...
{_doc.open();_doc.write(_iframeDocumentHTML);_doc.close();}
