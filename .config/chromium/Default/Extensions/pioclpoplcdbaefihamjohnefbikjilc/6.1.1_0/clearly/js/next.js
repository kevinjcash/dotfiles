...
{var _charset=(''+(($N.document.characterSet||$N.document.charset)||''));$.ajax({'url':_nextPageURL,'type':'GET','dataType':'html','async':true,'timeout':(10*1000),'beforeSend':function(_xhr){_xhr.overrideMimeType('text/html; charset='+$N.escape_html(_charset));},'success':function(_response,_textStatus,_xhr){$N.nextPage__ajaxComplete(_pageNr,_response,_textStatus,_xhr,_nextPageURL);},'error':function(_xhr,_textStatus,_error){$N.nextPage__ajaxError(_pageNr,_xhr,_textStatus,_error);}});};$N.nextPage__ajaxError=function(_pageNr,_xhr,_textStatus,_error){};$N.nextPage__ajaxComplete=function(_pageNr,_response,_textStatus,_xhr,_url)
