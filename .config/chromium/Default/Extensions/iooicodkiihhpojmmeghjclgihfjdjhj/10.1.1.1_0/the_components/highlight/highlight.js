...
//  ============
    ...
    $H.insertCSS = function ()
    {
        var _cssText = ''                                                                                                       +
            ...
            '   cursor: url("'+$H.settings.imgPath+'highlight--cursor.png") 14 16, text; '                                      +
            '} '                                                                                                                +

            '/'+'* highlight tag *'+'/ '                                                                                              +
            'em.'+$H.settings.highlightElementCSSClass+' { '                                                                    +
            '   font-style: inherit !important; font-weight: inherit !important; '                                              +
            '   background-image: url("'+$H.settings.imgPath+'highlight--yellow.png"); '                                        +
            ...
            '   background-image: url("'+$H.settings.imgPath+'highlight--delete-sprite.png"); background-repeat: no-repeat; background-position: 0px 0px; ' +
            '} '                                                                                                                +
            ...
            '   em.'+$H.settings.highlightElementCSSClass+' { background-image: url("'+$H.settings.imgPath+'highlight--yellow@2x.png"); } ' +
            '   em.'+$H.settings.highlightElementCSSClass+' a.'+$H.settings.highlightElementDeleteCSSClass+' { background-image: url("'+$H.settings.imgPath+'highlight--delete-sprite@2x.png"); background-size: 68px 34px; } ' +
            '} '                                                                                                                +
        '';
