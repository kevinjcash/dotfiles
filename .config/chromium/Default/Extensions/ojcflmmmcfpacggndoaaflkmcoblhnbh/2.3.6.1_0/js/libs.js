                ...
                if (!this.inited) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(factory)) {
                            ...
                            // name the anonymous function-modules
                            if (typeof exports === 'function' && !exports.name && exports.__super__) {
                                exports._name = id;
                                exports.toString = function () { return id; }
                            }
...
(function (factory) {
  ...
  if (typeof define === "function" && define.amd) {
    define('vendor/lodash',['wunderbits/global'], factory);
  }
  else {
    factory(window);
  }
...
(function (init) {
  ...
  if (typeof define === "function" && define.amd) {
    define('vendor/jquery',['wunderbits/global'], init);
  }
  else {
    window.$ = init(window);
  }
...
(function(factory) {
  if(typeof define === "function" && define.amd) {
    define('vendor/backbone',['vendor/jquery', 'vendor/lodash'], factory);
  } else {
    factory();
  }
...
define('vendor/ua-detector',[],function() {
  ...
  function searchString(dataBrowser) {
    for (var b = 0; b < dataBrowser.length; b++) {
      var c = dataBrowser[b].string;
      var d = dataBrowser[b].prop;
      versionSearchString = dataBrowser[b].versionSearch || dataBrowser[b].identity;
      if (c) {
        if (c.indexOf(dataBrowser[b].subString) != -1) {
          return dataBrowser[b].identity;
        }
      } else {
        if (d) {
          return dataBrowser[b].identity;
  ...
  function searchVersion(c) {
    var b = c.indexOf(versionSearchString);
    if (b == -1) {
      return;
    }
    return parseFloat(c.substring(b + versionSearchString.length + 1), 10);
  }
...
* Licensed MIT
*/
define('vendor/jquerypp/dom/styles',['vendor/jquery'], function ($) {
...
* Licensed MIT
*/
define('vendor/jquerypp/dom/animate',['vendor/jquery', 'vendor/jquerypp/dom/styles'], function ($) {
...
* Licensed MIT
*/
define('vendor/jquerypp/dom/compare',['vendor/jquery'], function (jQuery) {
...
* Licensed MIT
*/
define('vendor/jquerypp/dom/within',['vendor/jquery'], function ($) {
...
* Licensed MIT
*/
define('vendor/jquerypp/lang/vector',['vendor/jquery'], function ($) {
	...
	$.Event.prototype.vector = function () {
		...
		var touches = typeof Touch == 'object' && this.originalEvent.touches && this.originalEvent.touches.length ? this.originalEvent.changedTouches[0] : this;
		if (this.originalEvent || this.originalEvent.synthetic) {

			var doc = document.documentElement,
				body = document.body;
			return new $.Vector((touches.clientX || (touches.originalEvent.changedTouches && touches.originalEvent.changedTouches[0].clientX)) + (doc && doc.scrollLeft || body && body.scrollLeft || 0) - (doc.clientLeft || 0), (touches.clientY || (touches.originalEvent.changedTouches && touches.originalEvent.changedTouches[0].clientY)) + (doc && doc.scrollTop || body && body.scrollTop ||  0) - (doc.clientTop || 0));
		} else {
...
* Licensed MIT
*/
define('vendor/jquerypp/event/livehack',['vendor/jquery'], function (jQuery) {
...
* Licensed MIT
*/
define('vendor/jquerypp/event/reverse',['vendor/jquery'], function ($) {
...
* Licensed MIT
*/
define('vendor/jquerypp/event/drag',['vendor/jquery', 'vendor/jquerypp/lang/vector', 'vendor/jquerypp/event/livehack', 'vendor/jquerypp/event/reverse'], function ($) {
	...
	var bind = function (object, method) {
		...
		supportTouch = (typeof Touch == 'object' || (('ontouchstart' in window) || (window.DocumentTouch && document instanceof window.DocumentTouch)))  || false,
		supportPointer =  window.navigator.msPointerEnabled !== undefined,
		// Use touch events or map it to mouse events
		startEvent = supportTouch ? "mousedown touchstart" : supportPointer ? "MSPointerDown" : "mousedown",
		stopEvent = supportTouch ? "mouseup touchend" : supportPointer ? "MSPointerUp" : "mouseup",
		moveEvent = supportTouch ? "mousemove touchmove" : supportPointer ? "MSPointerMove" : "mousemove",
	...
	$.extend($.Drag.prototype, {
		...
		mousemove: function (docEl, ev) {
			...
			this.element && this.element.trigger('move', this);
      ...
      if (supportTouch) {
		...
		draw: function (pointer, event) {
			...
			// default is prevented by jquerypp if touch device!
			if (supportTouch || !event.isDefaultPrevented()) {
		...
		position: function (newOffsetv) { //should draw it on the page
			...
			if (!this._cancelled && !this._horizontal) {
				//note, this was added here because of a subpixel rendering bug in chrome
				style.top = Math.round(this.required_css_position.top()) + "px";
			}
...
* Licensed MIT
*/
define('vendor/jquerypp/event/drag/limit',['vendor/jquery', 'vendor/jquerypp/event/drag', 'vendor/jquerypp/dom/styles'], function ($) {
...
* Licensed MIT
*/
define('vendor/jquerypp/event/drop',['vendor/jquery', 'vendor/jquerypp/event/drag', 'vendor/jquerypp/dom/within', 'vendor/jquerypp/dom/compare'], function ($) {
	var jQuery = $;
	var event = $.event;
...
* Licensed MIT
*/
define('vendor/jquerypp/event/drag/scroll',['vendor/jquery', 'vendor/jquerypp/event/drop'], function ($) { //needs drop to determine if respondable
	...
	$.Drag.prototype.scrolls = function (elements, options) {
		...
		for (var i = 0; i < elements.length; i++) {
			this.constructor && this.constructor.responder && this.constructor.responder._elements.push(elements.eq(i).data("_dropData", new $.Scrollable(elements[i], options))[0])
		}
	},
...
* Licensed MIT
*/
define('vendor/jquerypp/event/fastfix',['vendor/jquery'], function (jQuery) {
...
(function() {
    ...
    function _handleKey(e) {
        ...
        var which = typeof e.which == "number" ? e.which : e.keyCode;
    ...
    if (typeof define == 'function' && define.amd) {
        define('vendor/mousetrap',[],function() { return mousetrap; });
    }
}) ();
// Re-written version of https://github.com/eriwen/javascript-stacktrace
...
(function(init) {
  ...
  var global = this;
  var printStackTrace = init();
  if(typeof global.define === "function" && global.define.amd) {
    global.define('vendor/stacktrace', [], function() {
  ...
  function printStackTrace(e) {
    ...
    // if no/invalid error object is passed, create your own
    if(!(e instanceof Error)) {
      e = new Error();
    }

    var currentMode = mode(e);
    var args = arguments;
    (currentMode === 'other') && (e = args.callee);
    var stack = modes[currentMode](e);
    stack.mode = currentMode;
    return stack;
  }
...
define("vendor/stacktrace", function(){});
